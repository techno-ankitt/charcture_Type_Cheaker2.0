# Character Type Cheaker
**Developed by [Ankit Suthar]**
...
## Features
- **Categorization:** Detects if a character is UPPERCASE, lowercase, a Number, or a Special Character.
- **Input Cleaning:** Uses `.strip()` to handle accidental spaces.
